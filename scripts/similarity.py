...
pairs = [
    ...
    ("skills/address-feedback/references/fixer-prompt.md", "ce-resolve-pr-feedback/references/agents/pr-comment-resolver.md"),
    ("skills/address-feedback/scripts/pr-threads", "ce-resolve-pr-feedback/scripts/get-pr-comments"),
]
