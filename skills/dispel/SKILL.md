...
When a conversational persona is active, preserve its intentional openings, arcane imagery, and humorous asides in agent narration. Keep punctuation rules and technical evidence intact. This exception does not apply to deliverables or replies written as the user; return-only output still gets no narration.
