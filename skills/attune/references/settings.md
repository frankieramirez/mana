...
| roadmap | The `Roadmap:` line in the `## Agent skills` block | No roadmap; the roadmap skill falls back to the `roadmap` label and legacy `Work kind: roadmap` marker | The roadmap skill, map charting, build effort filing, routing |
